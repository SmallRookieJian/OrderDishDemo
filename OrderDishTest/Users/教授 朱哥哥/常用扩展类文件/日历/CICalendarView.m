...
- (UIView *)headerView
{
    if (!_headerView)
    {
        _headerView = [[UIView alloc] initWithFrame:CGRectMake(-0.5, 0, kCICalendarWidth+2, kCICalHeaderHeight)];
...
- (UIView *)gridContentView
{
    if (!_gridContentView)
    {
        _gridContentView = [[UIView alloc] initWithFrame:CGRectMake(-0.5, 0, kCICalendarWidth+4, kCICalendarHeight-kCICalHeaderHeight)];
...
{
    if (!_back) {
        _back = [[UIImageView alloc]initWithFrame:CGRectMake(-0.5, kCICalHeaderHeight, kCICalendarWidth+4, kCICalGridHeight-kCICalHeaderHeight)];
